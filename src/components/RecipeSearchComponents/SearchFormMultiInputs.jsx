  ...
  useEffect(() => {
    const fetchOptions = async () => {
      try {
        ...
        // Not sure why (because of strict mode?) but MealDB returns duplicates of the filter options  causing key collisions. as a temp (or permanent?) fix we now use 'new map' when setting our filter options. This way we transform the array of objects into an array of key/value pairs. so when the fetch fires off again the duplicates overwrites the current instead of stacking.
